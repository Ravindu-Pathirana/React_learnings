...
const studentcard =(student_details)=>{
    return React.createElement(
        "div",
        {className:"st-card"},
        React.createElement("img",{className:"student-image", src:student_details.image, alt:"student-image"}),
        React.createElement(student, {name: student_details.name, age: student_details.age, university: student_details.university})
    );
}
